<%-- 
    Document   : index
    Created on : 20-03-2019, 12:07:13
        ...
        <div class="row justify-content-center h-100">
            ...
            <div class="col-md-5 col-lg-3 align-self-center">
                <div class="login-box">
                    ...
                    <div class="box-title"><i class="fas fa-user" style="color: #6db6ff;"></i><span style="padding-left: 16px;">Log ind</span></div>
                    ...
                    <form action="/LegoHus/FrontController" Method="POST">
                        ...
                        <input style="font-family: 'Poppins', sans-serif;  font-weight: 600;" type="submit" class="btn btn-primary" value="Log ind">
                        <input type="hidden" name="command" value="login">
                    </form>
                    <div class="create-link">
                        <a href="/LegoHus/register.jsp" class="">Opret en bruger</a>
                    </div>
                </div>
            </div>
